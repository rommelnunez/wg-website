    ...
    <div className="min-h-screen bg-black text-white relative flex flex-col overflow-hidden">
      ...
      <main className="flex-1 relative z-10 flex flex-col justify-end p-8 md:p-20 pb-32">
        <div className="max-w-5xl">
          ...
          >
            <h1 className="font-display text-[15vw] leading-[0.85] tracking-tighter mb-12 drop-shadow-2xl mix-blend-screen transition-all duration-700 group-hover:tracking-normal group-hover:blur-[2px] group-hover:opacity-80">
              OUR HERO,<br />BALTHAZAR
              <sup className="text-[3vw] align-top ml-2 opacity-100 group-hover:text-red-500 transition-colors duration-500">*2026</sup>
            </h1>
          </Link>
